...
const VerticalBarChart: React.FC<BarChartProps> = ({data, title, subtitle, inputWidth, inputHeight}) => {
...
export const Bars: React.FC<BarsProps> = ({ data, height, scaleX, scaleY }) => {
  return (
    <>
