...
const ClassroomCard: React.FC<ClassroomCardProps> = ({ name, numMembers, recentAssignments, pendingMemberUsernames }) => {
    return (
        <Card className="flex w-full h-fit min-h-fit border-small border-default-300 p-6 bg-content1-base m-0" radius="md" shadow="none">
            <CardBody className="flex h-fit min-h-fit p-0 m-0 gap-4">
