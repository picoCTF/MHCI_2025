...
const ChallengeDiv: React.FC<ChallengeDivProps> = ({ /*challengeID*/ }) => {
    ...
    if(challengeData && !challengeDataLoading) {
        ...
        if(!isComplete) {
            ...
            if(!challengeData.solved_by_user && isComplete) {

                //FIX_ME - The page reloads whenever the form is submitted, causing the completion to reset
                ...
                return ( 
                    <div className="flex flex-col w-full h-full min-h-fit gap-10">
                        ...
                        <div className="flex flex-col gap-5 items-center">
                            ...
                            <ReflectionCTACard challengeID={challengeData.id} />
                        </div>
                    </div>
                );
            }
                ...
                <div className="flex flex-row gap-4">
                    <div className="flex flex-row gap-2">
                        ...
                        <Skeleton className="flex w-fit h-fit rounded-full">
                            <p className={"flex font-mono text-default-500"}>Author: Name Here</p>
                        </Skeleton>
                    </div>
                    <div className="flex flex-row gap-2">
                        <Skeleton className="rounded-full w-5 h-5"/>
