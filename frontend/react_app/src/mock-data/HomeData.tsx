import type { AssignmentCardProps } from "../components/General/AssignmentCard";
import type { ClassroomCardProps } from "../components/General/ClassroomCard";
import type { QuickLinkCardProps } from "../components/General/QuickLinkCard";
import type { TimeStringProps } from "../Interfaces";

export const quickLinksList: QuickLinkCardProps[] = [
    {
        name: "Community",
...
export const assignmentsList: AssignmentCardProps[] = [
    {
        name: "Assignment 1",
...
export const classroomsList: ClassroomCardProps[] = [
    {
        name: "Classroom 1",
        numMembers: 20,
        recentAssignments: [
