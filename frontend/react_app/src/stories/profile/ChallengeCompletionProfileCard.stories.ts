...
const meta = {
  title: 'Profile/ChallengeCompletionProfileCard',
  component: ChallengeCompletionProfileCard,
...
} satisfies Meta<typeof ChallengeCompletionProfileCard>;
...
export const Default: Story = {
  args: {
    numEasyChallenges: 5,
    numMediumChallenges: 4,
    numHardChallenges: 1,
    totalNumChallenges: 10
  },
};
