...
- Update any HTML to use semantic tags rather than simple divs and add aria-labels and other accessibility features to make the website more compatible with screen readers.